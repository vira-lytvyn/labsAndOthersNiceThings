...
void bud (TPaintBox *Image1, TComboBox *ComboBox3)
{
try {
l=60;
maxx=Xe[Ne-1];
...
if (minx*maxx<=0)
  ...
  {
    case   0: {    //{вибір стилю відображення}
				Image1->Canvas->Pen->Style = psSolid;
                Image1->Canvas->Pen->Width = 2;

			  break;
			  }
	 case   1:  {    //{вибір стилю відображення}
				Image1->Canvas->Pen->Style = psDot;
				Image1->Canvas->Pen->Width = 1;

			  break;
		  }
	 case   2:  {    //{вибір стилю відображення}
  ...
  Image1->Canvas->MoveTo(floor(kx*Xe[0]+zx), floor(ky*Ye[0]+zy));       // {побудова одного графіка}
	  for (i=0; i<Ne-1; i++)
		{
		...
		if (grafs == true)
		{
		  Image1->Canvas->MoveTo(floor(kx*Xe[Ne+1]+zx), floor(ky*Ye[Ne+1]+zy));     //{побудова другого графіка}
		  for (i = Ne+1; i<Ne*2; i++)
		  {
...
switch (ComboBox2->ItemIndex)
  {
    case   0: {
              ...
              grafs = true;
              Xe[0] = al;
              for (i=0; i<Ne-1; i++)             //{Табуляція функцій x*sin(x) та x*cos(x)}
              {
                Ye[i] = f3(Xe[i]);
                Xe[i+1] = Xe[i]+h;
              }
     ...
     case   1:  {
              ...
              grafs = true;
              Xe[0] = al;
              for (i=0; i<Ne-1; i++)              //{Табуляція функцій sin(x) та cos(x)}
              {
                Ye[i] = f1(Xe[i]);
                Xe[i+1] = Xe[i]+h;
              }
     ...
     case  2:  {
              ...
              grafs = true;
              Xe[0] = al;
              for (i=0; i<Ne-1; i++)            //{Табуляція функцій sin(x) та x*cos(x)}
              {
                Ye[i] = f1(Xe[i]);
                Xe[i+1] = Xe[i]+h ;
              }
...
switch (ComboBox1->ItemIndex)
	  ...
	  case 0: {
			...
			grafs = false;
			Xe[0] = al;
			for (i=0; i<Ne-1; i++)             //Табуляція функції sin(x)
			{
			  Ye[i] = f1(Xe[i]);
			  Xe[i+1] = Xe[i]+h;
			}
	 ...
	 case 1: {
			...
			grafs = false;
			Xe[0] = al;
			for (i=0; i<Ne-1; i++)             //{Табуляція функції cos(x)}
			{
			  Ye[i] = f2(Xe[i]);
			  Xe[i+1] = Xe[i]+h;
			}
	 ...
	 case 2: {
			...
			grafs = false;
			Xe[0] = al;
			for (i=0; i<Ne-1; i++)            //{Табуляція функції x*sin(x)}
		   {
			  Ye[i] = f3(Xe[i]);
			  Xe[i+1] = Xe[i]+h;
			}
