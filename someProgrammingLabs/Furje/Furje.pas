         ...
         begin
           ...
           for i := 0 to Ngr - 1 do
             Begin
               ...
               Ellipse(Round (Kx*Xe[round(i*krok)]+Zx)-2, Round(Ky*Ye[round(i*krok)]+Zy)-2,
               Round (Kx*Xe[round(i*krok)]+Zx)+2, Round(Ky*Ye[round(i*krok)]+Zy)+2);
  ...
  1:Begin
      ...
      with Image1.Canvas do
            begin
               ...
               Ellipse(Round (Kx*Xe[round(i*krok)]+Zx)-2, Round(Ky*Ye[round(i*krok)]+Zy)-2,Round (Kx*Xe[round(i*krok)]+Zx)+2, Round(Ky*Ye[round(i*krok)]+Zy)+2);
               end;
               Pen.Color:=clAqua;
               Pen.Width:=2;
               Pen.Style:=psSolid;
