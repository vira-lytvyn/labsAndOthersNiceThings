    ...
    public partial class Form1 : Form
    {
        ...
        private void SolveBTN_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rows - 1; i++)
            {
                for (int j = 0; j < 2; j++)
                {
                    int randValue = rand.Next(studentNumder - 3, studentNumder + 3);
            ...
            do
            {
                ...
                for (int i = 1; i < listOfSets.Count; i++)
                {
                    ...
                    if (!isCompatible)
                    {
                        ...
                        if (currentItem[0] >= item[0] && currentItem[1] >= item[1])
            ...
            CalculationDGV[6, indexOfMaxValue + 1].Style.BackColor = Color.Salmon;
            ...
            CalculationDGV[7, 0].Value = "Відстань";
            ...
            CalculationDGV[7, indexOfMinValue + 1].Style.BackColor = Color.Lime;
        }        
    }
}
