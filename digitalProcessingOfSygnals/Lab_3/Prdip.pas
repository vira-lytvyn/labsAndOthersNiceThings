  ...
  if Key=VK_RETURN then
    ...
    1:begin
     ...
     {FNCh}
       ...
       8:begin   {Zmenshennay u zadanu kilkist raz}
          k:=StrToInt(Edit1.Text);
          j1:=1; ly:=1;
          len:= round(256/k);
          repeat
          ...
          begin
            for j:=1 to 256 do
              begin
                ...
                BitMap3.Canvas.Pixels[(i+len div 2-1),(j+len div 2-1)]:=cl;
              end;
          end;
          Image3.Picture.Assign(BitMap3);
       end;

       9:begin   {povorot na zadanyj kut}
