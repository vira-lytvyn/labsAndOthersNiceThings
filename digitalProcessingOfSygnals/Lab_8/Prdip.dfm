object Form1: TForm1
  ...
  object MainMenu1: TMainMenu
    ...
    object N2: TMenuItem
      ...
      object G1: TMenuItem
        Caption = #1042#1080#1076#1110#1083#1077#1085#1085#1103' '#1082#1086#1085#1090#1091#1088#1072
        object N29: TMenuItem
          Caption = #1052#1072#1089#1082#1072' '#1083#1072#1087#1083#1072#1089#1110#1072#1085#1072' 4'
          OnClick = N29Click
        end
        object N33: TMenuItem
          Caption = #1052#1072#1089#1082#1072' '#1083#1072#1087#1083#1072#1089#1110#1072#1085#1072' 8'
          OnClick = N33Click
        end
        object N41: TMenuItem
          Caption = #1043#1088#1072#1076#1110#1108#1085#1090#1085#1072' '#1084#1072#1089#1082#1072
          OnClick = N41Click
        end
      end
      object N34: TMenuItem
        Caption = #1063#1080#1097#1077#1085#1085#1103' '#1074#1110#1076' '#1096#1091#1084#1091
        object N35: TMenuItem
          Caption = #1051#1110#1085#1110#1081#1085#1080#1081' '#1092#1110#1083#1100#1090#1088
          OnClick = N35Click
        end
        object N36: TMenuItem
          Caption = #1052#1077#1076#1110#1072#1085#1085#1080#1081' '#1092#1110#1083#1100#1090#1088
          OnClick = N36Click
        end
      end
    end
    object N13: TMenuItem
      ...
      object N37: TMenuItem
        Caption = #1060#1053#1063' '#1041#1072#1090#1090#1077#1088#1074#1086#1088#1090#1072
        OnClick = N37Click
      end
      ...
      object N38: TMenuItem
        Caption = #1060#1042#1063' '#1041#1072#1090#1090#1077#1088#1074#1086#1088#1090#1072
        OnClick = N38Click
      end
    end
    object S1: TMenuItem
      Caption = #1030#1085#1076#1080#1074#1110#1076#1091#1072#1083#1100#1085#1077' '#1079#1072#1074#1076#1072#1085#1085#1103
      object N39: TMenuItem
        Caption = #1042#1080#1076#1080#1084#1080#1081' '#1076#1110#1072#1084#1077#1090#1088
      end
      object N40: TMenuItem
        Caption = #1042#1080#1076#1080#1084#1072' '#1087#1083#1086#1097#1072
      end
    end
  end
