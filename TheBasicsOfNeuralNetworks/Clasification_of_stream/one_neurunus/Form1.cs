    ...
    public partial class Form1 : Form
    {
        ...
        private void studyBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                patterns = RandomGenerator.GenerateSets(mx1, dx1, mx2, dx2, stPairsCount);

                Clasification = new NeronNetwork.Culculation();
                Clasification.Run(patterns, stError, stSpeed, sygma, maxIter);
        ...
        private void testBtn_Click(object sender, EventArgs e)
        {
            ...
            double dx1 = Convert.ToDouble(DX1TB.Text);
            double dx2 = Convert.ToDouble(DX2TB.Text);
            double[][] testPairs = RandomGenerator.GenerateSets(mx1, dx1, mx2, dx2, stPairsCount);
