...
public class PerceptronDigitsAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(perceptrondigits.PerceptronDigitsApp.class).getContext().getResourceMap(PerceptronDigitsAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(perceptrondigits.PerceptronDigitsApp.class).getContext().getActionMap(PerceptronDigitsAboutBox.class, this);
